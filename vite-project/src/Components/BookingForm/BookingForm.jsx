...
const BookingForm = ({ children }) => {
  ...
  return (
    ...
    <div >
      ...
      <div className="BookingForm" style={{ display: "flex", justifyContent: "center", gap: "50px", alignItems: "flex-start" }}>
        <div style={{ display: "flex", justifyContent: "flex-start", marginTop: "150px" }}>
          {" "}
