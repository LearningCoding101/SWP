    ...
    const handleError = (error) => {
      ...
      const fetchBookingDetails = async (bookingId) => {
        ...
        try {
          ...
          const response = await axios.get(`http://badcourts.click:8080/api/bookingDetail/qrcheck/${bookingId}`, {
            headers: {
            ...
            <div className="col-md-4">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  />
                  <button className="btn btn-custom-secondary mt-3" onClick={refreshScanner}>
                    Refresh Scanner
                  </button>
