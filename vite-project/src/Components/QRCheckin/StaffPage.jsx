...
const QRScanner = () => {
    ...
    const token = "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJuZ3V5ZW5uaG0ubC4xOTIyQGdtYWlsLmNvbSIsImlhdCI6MTcxODgxMzM5NywiZXhwIjoxNzE4ODk5Nzk3fQ.T_S2lUWTTxwObnHbosL83_Ex44LNNabPfFNEZ3CeqpPWkwzNYdSCwmAeoteqChnu"; // Store the token in environment variables
