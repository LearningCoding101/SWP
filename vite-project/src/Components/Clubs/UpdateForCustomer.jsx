                            ...
                            <Col key={index} span={10}>
                                <Card title={`Court: ${booking.courtName}`} style={{ margin: '0 auto' }}>
                                    <Space direction="vertical">
                                        ...
                                        <Button onClick={() => showModal(booking)} disabled={moment().add(24, 'hours') > moment(booking.bookingDate)}>Update</Button>
                                    </Space>
                                </Card>
                                    ...
                                    <Form onFinish={handleUpdate}>
                                        ...
                                        <Form.Item name="date">
                                            <DatePicker
                                                ...
                                                disabledDate={(current) => current && current < moment().endOf('day').add(24, 'hours')}
                                            />
                                        </Form.Item>
