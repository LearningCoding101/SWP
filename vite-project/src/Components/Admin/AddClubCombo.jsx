...
const AddClubCombo = () => {
    ...
    return (
        <div className="container vh-100 d-flex justify-content-center align-items-center">
            <div className="card p-4 shadow-lg" style={{ width: '100%', maxWidth: '1000px' }}>
                ...
                <form onSubmit={handleAdd}>
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                <label htmlFor="address" className="form-label">Club address</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div className="mb-3">
                                <label htmlFor="picture_location" className="form-label">Club picture</label>
                                <input
                                    type="file"
                                    required
