      ...
      <main>
        <Router>
          <Routes>
            ...
            <Route path="/setPasswordActiveClub" element={<SetPassConfirm />} />
            <Route path="/clubs" element={<Club />} />
            <Route path="/clubs/:address" element={<ClubDetail />} />
            <Route path="/bookingHistory" element={<BookingHistoryPage />} />
            <Route path="/booking/:id" element={<BookingForm />} />
            <Route path="/showBooking/:courtId" element={<ShowBookingList />} />
            <Route path="/transactions" element={<Transaction />} />

            <Route path="/RevenueChart/:clubId" element={<RevenueChart />} />
